...
public class AlertThreadTest {
    ...
    public static void setUpClass() {
        ...
        alert1_ = new Alert(1, "alert1", "alert1_description" , 11, false, true, true, Alert.TYPE_THRESHOLD, true, true, 300000, 
            1, Alert.OPERATOR_GREATER, Alert.COMBINATION_ALL, null, new BigDecimal("100"), 900L, null, 1, false, new Timestamp(System.currentTimeMillis()), false, null, null,
            1, Alert.OPERATOR_GREATER, Alert.COMBINATION_ALL, null, new BigDecimal("200"), 1000L, null, 2, true, new Timestamp(System.currentTimeMillis()), false, null, null);
        
        alert2_ = new Alert(2, "alert2", "alert2_description" , 11, true, true, true, Alert.TYPE_THRESHOLD, true, true, 300000, 
            1, Alert.OPERATOR_GREATER, Alert.COMBINATION_ALL, null, new BigDecimal("100"), 900L, null, 1, true, new Timestamp(System.currentTimeMillis()), false, null, null,
            1, Alert.OPERATOR_GREATER, Alert.COMBINATION_ALL, null, new BigDecimal("200"), 1000L, null, 2, false, new Timestamp(System.currentTimeMillis()), false, null, null);
