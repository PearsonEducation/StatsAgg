...
public class GraphiteMetricRawTest {
    ...
    @Before
    public void setUp() {
        graphiteMetricRaw1_ = new GraphiteMetricRaw("test.metric.path", "12345.123", "1382848111", Long.valueOf("1382848222222").longValue());
        graphiteMetricRaw2_ = new GraphiteMetricRaw("test.metric.path?><!@#$!", "12345", "123", Long.valueOf("1234").longValue());
        graphiteMetricRaw3_ = new GraphiteMetricRaw("test.metric.path", "12345.123", "1382848111", Long.valueOf("1382848222222").longValue()); // same as Raw1
    }
    ...
    public void testEquals() {
        ...
        GraphiteMetricRaw graphiteMetricRaw = new GraphiteMetricRaw("test.metric.path.", "12345.123", "1382848111", Long.valueOf("1382848222222").longValue());
        assertNotEquals(graphiteMetricRaw1_, graphiteMetricRaw);
        
        graphiteMetricRaw = new GraphiteMetricRaw("test.metric.path", "12345.1234", "1382848111", Long.valueOf("1382848222222").longValue());
        assertNotEquals(graphiteMetricRaw1_, graphiteMetricRaw);
        
        graphiteMetricRaw = new GraphiteMetricRaw("test.metric.path", "12345.123", "1382848112", Long.valueOf("1382848222222").longValue());
        assertNotEquals(graphiteMetricRaw1_, graphiteMetricRaw);
        
        graphiteMetricRaw = new GraphiteMetricRaw("test.metric.path", "12345.123", "1382848111", Long.valueOf("1382848222221").longValue());
        assertNotEquals(graphiteMetricRaw1_, graphiteMetricRaw);
    }
    ...
    public void testParseGraphiteMetricsRaw() {
        ...
        expectedGraphiteMetricsRaw.add(new GraphiteMetricRaw("test.metric.path1", "12345", "1382848111", Long.valueOf("1382848222222").longValue()));
        expectedGraphiteMetricsRaw.add(new GraphiteMetricRaw("test.metric.path2", "12345.2", "1382848119", Long.valueOf("1382848222222").longValue()));
    ...
    public void testGetMostRecentGraphiteMetricRawByMetricPath() {
        ...
        GraphiteMetricRaw graphiteMetricRaw1 = new GraphiteMetricRaw("test.metric.path1", "12345.1",  "1382848111", Long.valueOf("1382848222222").longValue());
        GraphiteMetricRaw graphiteMetricRaw2 = new GraphiteMetricRaw("test.metric.path1", "12345",    "1382848113", Long.valueOf("1382848222220").longValue());
        GraphiteMetricRaw graphiteMetricRaw3 = new GraphiteMetricRaw("test.metric.path1", "12345.23", "1382848112", Long.valueOf("1382848222223").longValue());
        
        GraphiteMetricRaw graphiteMetricRaw4 = new GraphiteMetricRaw("test.metric.path2", "12345.2",  "1382848111", Long.valueOf("1382848222222").longValue());   
        
        GraphiteMetricRaw graphiteMetricRaw5 = new GraphiteMetricRaw("test.metric.path3", "12345.1",  "1382848111", Long.valueOf("1382848222222").longValue());
        GraphiteMetricRaw graphiteMetricRaw6 = new GraphiteMetricRaw("test.metric.path3", "12345",    "1382848112", Long.valueOf("1382848222220").longValue());
        GraphiteMetricRaw graphiteMetricRaw7 = new GraphiteMetricRaw("test.metric.path3", "12345.23", "1382848112", Long.valueOf("1382848222223").longValue());
        GraphiteMetricRaw graphiteMetricRaw8 = new GraphiteMetricRaw("test.metric.path3", "12345.23", "1382848110", Long.valueOf("1382848222224").longValue());
    ...
    public void testGetMetricTimestampInt() {
        ...
        assertEquals(graphiteMetricRaw1_.getMetricTimestampInt(), new Integer(graphiteMetricRaw1_.getMetricTimestamp()));
        assertEquals(graphiteMetricRaw2_.getMetricTimestampInt(), new Integer(graphiteMetricRaw2_.getMetricTimestamp()));
