...
import com.pearson.statsagg.metric_aggregation.StatsdMetricAggregator;
 ...
 */
public class StatsdThread implements Runnable {

    private static final Logger logger = LoggerFactory.getLogger(StatsdThread.class.getName());
    ...
    public StatsdThread(Long threadStartTimestampInMilliseconds) {
