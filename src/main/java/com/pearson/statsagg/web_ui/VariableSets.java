...
public class VariableSets extends HttpServlet {
    ...
    private String buildVariableSetsHtml() {
        ...
        //Set<Integer> variableSetIdsAssociatedWithNotificationGroups = NotificationGroupsDao.getDistinctVariableSetIdsAssociatedWithNotificationGroups(DatabaseConnections.getConnection(), true);
        Set<Integer> variableSetIdsAssociatedWithNotificationGroups = new HashSet<>();
        List<VariableSet> variableSets = VariableSetsDao.getVariableSets(DatabaseConnections.getConnection(), true);
        ...
        for (VariableSet variableSet : variableSets) {     
            ...
            if (variableSetIdsAssociatedWithNotificationGroups == null) htmlBodyStringBuilder.append(", ").append(remove);
            else if (!variableSetIdsAssociatedWithNotificationGroups.contains(variableSet.getId())) htmlBodyStringBuilder.append(", ").append(remove);
