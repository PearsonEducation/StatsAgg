        ...
        try {
            ...
            if (alert != null) {
              ...
              if (alert.getResendAlertEveryTimeUnit()!= null) {
                alertDetails.put("resend_alert_every_time_unit", alert.getResendAlertEveryTimeUnit());
              }
              ...
              if (alert.getCautionWindowDurationTimeUnit()!= null) {
                alertDetails.put("caution_window_duration_time_unit", alert.getCautionWindowDurationTimeUnit());
              }
              ...
              if (alert.getCautionStopTrackingAfterTimeUnit()!= null) {
                alertDetails.put("caution_stop_tracking_after_time_unit", alert.getCautionStopTrackingAfterTimeUnit());
              }
              ...
              if (alert.getCautionActiveAlertsSet()!= null) {
                alertDetails.put("caution_active_alerts_set", alert.getCautionActiveAlertsSet());
              }
              ...
              if (alert.getDangerWindowDurationTimeUnit()!= null) {
                alertDetails.put("danger_window_duration_time_unit", alert.getDangerWindowDurationTimeUnit());
              }
              ...
              if (alert.getDangerStopTrackingAfterTimeUnit()!= null) {
                alertDetails.put("danger_stop_tracking_after_time_unit", alert.getDangerStopTrackingAfterTimeUnit());
              }
              ...
              if (alert.getDangerActiveAlertsSet()!= null) {
                alertDetails.put("danger_active_alerts_set", alert.getDangerActiveAlertsSet());
              }
              if (alert.getDangerFirstActiveAt()!= null) {
                alertDetails.put("danger_firstActiveAt_", alert.getDangerFirstActiveAt());
              }}
            } else {
