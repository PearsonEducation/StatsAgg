...
public class AlertsSql {
    ...
    protected final static String CreateIndex_Alerts_ForeignKey_CautionPositiveNotificationGroupId =
                    "ALTER TABLE ALERTS " +
                    "ADD CONSTRAINT A_CPNGID_FK FOREIGN KEY (CAUTION_POSITIVE_NOTIFICATION_GROUP_ID) " + 
                    "REFERENCES NOTIFICATION_GROUPS(ID)";
    
    protected final static String CreateIndex_Alerts_ForeignKey_DangerPositiveNotificationGroupId =
                    "ALTER TABLE ALERTS " +
                    "ADD CONSTRAINT A_DPNGID_FK FOREIGN KEY (DANGER_POSITIVE_NOTIFICATION_GROUP_ID) " + 
                    "REFERENCES NOTIFICATION_GROUPS(ID)";
    ...
    protected final static String Select_AllDistinctNotificationGroupIds = 
                    "(SELECT CAUTION_NOTIFICATION_GROUP_ID FROM ALERTS WHERE CAUTION_NOTIFICATION_GROUP_ID IS NOT NULL) " + 
                    "UNION " +
                    "(SELECT CAUTION_POSITIVE_NOTIFICATION_GROUP_ID FROM ALERTS WHERE CAUTION_POSITIVE_NOTIFICATION_GROUP_ID IS NOT NULL) " + 
                    "UNION " +
                    "(SELECT DANGER_NOTIFICATION_GROUP_ID FROM ALERTS WHERE DANGER_NOTIFICATION_GROUP_ID IS NOT NULL) " + 
                    "UNION " +
                    "(SELECT DANGER_POSITIVE_NOTIFICATION_GROUP_ID FROM ALERTS WHERE DANGER_POSITIVE_NOTIFICATION_GROUP_ID IS NOT NULL)";
    ...
    protected final static String Insert_Alert =
                    ...
                    "ALERT_ON_POSITIIVE, ALLOW_RESEND_ALERT, RESEND_ALERT_EVERY, RESEND_ALERT_EVERY_TIME_UNIT, " + 
