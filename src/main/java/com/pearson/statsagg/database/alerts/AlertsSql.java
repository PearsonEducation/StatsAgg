...
public class AlertsSql {
    ...
    protected final static String Insert_Alert =
                    ...
                    "CAUTION_NOTIFICATION_GROUP_ID, CAUTION_OPERATOR, CAUTION_COMBINATION, CAUTION_COMBINATION_COUNT, CAUTION_THRESHOLD, CAUTION_WINDOW_DURATION, CAUTION_WINDOW_DURATION_TIME_UNIT, " +
                    "CAUTION_STOP_TRACKING_AFTER, CAUTION_STOP_TRACKING_AFTER_TIME_UNIT, CAUTION_MINIMUM_SAMPLE_COUNT, IS_CAUTION_ALERT_ACTIVE, CAUTION_ALERT_LAST_SENT_TIMESTAMP, IS_CAUTION_ACKNOWLEDGED, " + 
                    "CAUTION_ACTIVE_ALERTS_SET, CAUTION_FIRST_ACTIVE_AT, " +
                    "DANGER_NOTIFICATION_GROUP_ID, DANGER_OPERATOR, DANGER_COMBINATION, DANGER_COMBINATION_COUNT, DANGER_THRESHOLD, DANGER_WINDOW_DURATION, DANGER_WINDOW_DURATION_TIME_UNIT, " +
                    "DANGER_STOP_TRACKING_AFTER, DANGER_STOP_TRACKING_AFTER_TIME_UNIT, DANGER_MINIMUM_SAMPLE_COUNT, IS_DANGER_ALERT_ACTIVE, DANGER_ALERT_LAST_SENT_TIMESTAMP, IS_DANGER_ACKNOWLEDGED, " +
                    "DANGER_ACTIVE_ALERTS_SET, DANGER_FIRST_ACTIVE_AT) " + 
                    "VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    protected final static String Update_Alert_ByPrimaryKey =
                    ...
                    "CAUTION_WINDOW_DURATION_TIME_UNIT = ?, CAUTION_STOP_TRACKING_AFTER = ?, CAUTION_STOP_TRACKING_AFTER_TIME_UNIT = ?, CAUTION_MINIMUM_SAMPLE_COUNT = ?, " + 
                    "IS_CAUTION_ALERT_ACTIVE = ?, CAUTION_ALERT_LAST_SENT_TIMESTAMP = ?, " + 
                    ...
                    "DANGER_WINDOW_DURATION_TIME_UNIT = ?, DANGER_STOP_TRACKING_AFTER = ?, DANGER_STOP_TRACKING_AFTER_TIME_UNIT = ?, DANGER_MINIMUM_SAMPLE_COUNT = ?, " + 
                    "IS_DANGER_ALERT_ACTIVE = ?, DANGER_ALERT_LAST_SENT_TIMESTAMP = ?, " + 
