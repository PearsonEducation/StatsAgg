...
ALTER TABLE ALERTS ADD COLUMN RESEND_ALERT_EVERY BIGINT;
UPDATE ALERTS SET RESEND_ALERT_EVERY = SEND_ALERT_EVERY_NUM_MILLISECONDS;
ALTER TABLE ALERTS DROP COLUMN SEND_ALERT_EVERY_NUM_MILLISECONDS;
ALTER TABLE ALERTS ADD COLUMN RESEND_ALERT_EVERY_TIME_UNIT INTEGER;
UPDATE ALERTS SET RESEND_ALERT_EVERY_TIME_UNIT = 74;